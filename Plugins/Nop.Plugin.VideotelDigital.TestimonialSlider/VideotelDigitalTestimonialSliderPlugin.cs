...
namespace Nop.Plugin.VideotelDigital.TestimonialSlider
{
    public class VideotelDigitalTestimonialSliderPlugin : BasePlugin, IWidgetPlugin
    {
        private readonly IPictureService _pictureService;
        private readonly ISettingService _settingService;
        private readonly IWebHelper _webHelper;

        public VideotelDigitalTestimonialSliderPlugin(IPictureService pictureService, 
        ...
        {
            return new List<string>() { "VideotelTestimonialSlider" };
        }
        ...
        public void GetConfigurationRoute(out string actionName, out string controllerName, out RouteValueDictionary routeValues)
        {
            ...
            controllerName = "VideotelDigitalTestimonialSlider";
            routeValues = new RouteValueDictionary() { { "Namespaces", "Nop.Plugin.VideotelDigital.TestimonialSlider.Controllers" }, { "area", null } };
        }
        ...
        public void GetDisplayWidgetRoute(string widgetZone, out string actionName, out string controllerName, out RouteValueDictionary routeValues)
        {
            ...
            {
                {"Namespaces", "Nop.Plugin.VideotelDigital.TestimonialSlider.Controllers"},
                {"area", null},
        ...
        {
            //pictures
            var sampleImagesPath = _webHelper.MapPath("~/Plugins/VideotelDigital.TestimonialSlider/Content/testimonialslider/sample-images/");


            //settings
            var settings = new VideotelDigitalTestimonialSliderSettings()
            {
